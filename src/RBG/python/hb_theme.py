...
class HBTheme:
    ...
    vertex_outline: RGB = (255, 255, 255)
    ...
    # ---- Widget style snippets (no f-strings) ----
    def player_btn_style(self, team: str) -> str:
        if team == "blue":
            ...
            bg = self.green_q().name()
        return "background-color: {}; border-radius: 20px; border: 2px solid white;".format(bg)

    def hint_btn_style(self, active: bool) -> str:
        if active:
            return "background-color: {}; color: {}; font-weight: bold;".format(self.hint_on_bg, self.hint_on_text)
        return "background-color: {}; color: {};".format(self.hint_off_bg, self.hint_off_text)

    def edu_btn_style(self, active: bool) -> str:
        if active:
            return "font-size: {}px; background-color: {}; color: white; border: 2px solid white; border-radius: {}px;".format(self.icon_btn_font_size, self.edu_on_bg, self.btn_radius)

        return "font-size: {}px; background-color: {}; color: {}; border: {}px solid {}; border-radius: {}px;".format(
            self.icon_btn_font_size, self.btn_bg, self.btn_text, self.border_w, self.border_color, self.btn_radius)

    def edit_btn_style(self, active: bool) -> str:
        if active:
            return "font-size: {}px; background-color: {}; color: white; border: 2px solid white; border-radius: {}px;".format(self.icon_btn_font_size, self.edit_on_bg, self.btn_radius)
        return "font-size: {}px; background-color: {}; color: {}; border: {}px solid {}; border-radius: {}px;".format(
            self.icon_btn_font_size, self.btn_bg, self.btn_text, self.border_w, self.border_color, self.btn_radius)


class ThemeManager(QObject):
    # signal(theme), vse co je prihlase se prebarvi
